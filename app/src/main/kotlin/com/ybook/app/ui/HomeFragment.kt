...
public class HomeFragment() : Fragment(), OnClickListener {
    ...
    fun initViews(mainView: View): View {
        ...
        //        val adapter = HomeExpandableListAdapter()
        //        listView setAdapter adapter
        //        listView setChildDivider getResources().getDrawable(android.R.color.transparent)
        //        listView setGroupIndicator null

        //        val view = listView.getAdapter().getView(0,)
        //        val widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(ViewGroup.LayoutParams.MATCH_PARENT, View.MeasureSpec.EXACTLY)
        //        val heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(ViewGroup.LayoutParams.WRAP_CONTENT, View.MeasureSpec.EXACTLY)
        //        listView.measure(widthMeasureSpec, heightMeasureSpec)
        val headA = mainView id R.id.mapHeadA
        val headB = mainView id R.id.mapHeadB
        val headC = mainView id R.id.mapHeadC
        val headD = mainView id R.id.mapHeadD
        headA setTag (mainView id R.id.mapItemA)
        headB setTag (mainView id R.id.mapItemB)
        headC setTag (mainView id R.id.mapItemC)
        headD setTag (mainView id R.id.mapItemD)
        headA setOnClickListener this
        headB setOnClickListener this
        headC setOnClickListener this
        headD setOnClickListener this
